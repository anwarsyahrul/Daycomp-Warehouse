...
<div class="container">
    ...
    <form action="{{ route('suppliers.update', $supplier->id) }}" method="POST" class="fade-in-up">
        @csrf
        @method('PUT')
        ...
        <div class="mb-3">
            ...
            <input type="text" name="contact_info" id="contact_info" class="form-control" value="{{ old('contact_info', $supplier->contact_info) }}">
        </div>
        ...
        <button type="submit" class="btn btn-primary add-btn">Update Supplier</button>
    </form>
</div>
